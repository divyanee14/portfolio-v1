            ...
            <div className="hidden md:block">
              <div className="flex justify-center mt-4 md:mt-16">
                <p className="text-white w-4/5 text-[15px] sm:text-[18px] md:text-[20px]  font-bricolage">
                  ...
                  <br />
                  I'm Divyanee bhoyar, a Electronic and communication engineering  graduate from
                  the Shri ram institute of technology, driven by the passion to excel as a
                  ...
                  foundation in frontend technologies to bring creative <designs></designs>
