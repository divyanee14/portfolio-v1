...
import newogo from "../images/divya-logo.jpg";
          ...
          <div className="flex flex-col items-start mt-4 md:mt-0">
            ...
            <div className="mt-3 flex gap-1">
              <div className="h-[45px] md:h-[60px] cursor-pointer">
                <a href="https://www.linkedin.com/in/divyanee-bhoyar-a03117227/">
                  <img src={linkedin} className="h-full" />
                </a>
              </div>
              <div className="h-[45px] md:h-[60px] cursor-pointer">
                <a href="mailto:divyaneebhoyar1996@gmail.com">
                  <img src={gmail} className="h-full" />
                </a>
              </div>
              <div className="h-[45px] md:h-[60px] cursor-pointer">
                <Link to="https://github.com/divyanee14">
